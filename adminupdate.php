			    ...
			    if ($audit>0)
			    {
					...
					elseif ($group == "duration")
					{
					    ...
					    else
					    {
						    ...
						    $query12  = "SELECT * FROM accounts WHERE email = '$direction'";
					...
					else
					{
					    ...
					    {
					    	$query18 = "SELECT * FROM history WHERE email = '$direction'";
						    ...
						    if($exhibit>0)
						    {
						    	...
						    	{
						    		$query19 = "UPDATE history SET registration = '$alter' WHERE registration = '$label' AND email = '$direction'";
						    ...
						    $query16  = "SELECT * FROM accounts WHERE email = '$direction'";
