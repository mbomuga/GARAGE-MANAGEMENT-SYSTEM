...
<head>
	...
	<body>
		...
		<div>
			<center>
				<fieldset id = "drape">
					<form name = "usersearch" method = "post" action = "searchhistory.php" onsubmit = "return(usersearch());">
					...
					  </div>
					  <button type="submit" class="btn btn-dark" name = "usage">Search History</button>
					</form>
				</fieldset>
			</center>
		</div>
